...
class FileHandler:
    ...
    def create_table(self, table_name, *params  ):
        ...
        self.db_obj.db_table_create(table_name, *res)
    ...
    def query_create(self):
        if self.db_obj.db_if_table_exsists(self.tables[0][1])==1:
            ...
            if self.comm[0][1]=='delete':
                ...
                self.create_table(self.tables[0][1], *self.params  )
                self.db_obj.db_insert(self.tables[0][1], *self.params  )
                

    def parse_cfile(self,file_content):
        '''
        Handling files
        '''
        self.get_query_types(file_content)
